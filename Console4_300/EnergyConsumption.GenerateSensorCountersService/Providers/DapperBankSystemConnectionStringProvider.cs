...
namespace EnergyConsumption.GenerateSensorCountersService.Providers
{
    public class DapperBankSystemConnectionStringProvider : IDapperConnectionStringProvider
    {
        ...
        public string ConnectionString => "Server=newamber;Database=banksystem;Trusted_Connection=False;MultipleActiveResultSets=true;User Id=sa; Password=qazWSX123;";
    }
}
